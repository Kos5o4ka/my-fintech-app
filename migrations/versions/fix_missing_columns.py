...
def upgrade():
    with op.batch_alter_table('users', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('email_notifications', sa.Boolean(), nullable=True, server_default='false'))
    ...
    with op.batch_alter_table('bond_portfolio', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('broker_commission', sa.Numeric(precision=10, scale=4), nullable=True))
