...
> Версия проекта: **v2.1.0** | Следующий этап: **12 — Мультиключевой импорт и Валюты**
...
### Этап 12 — Мультиключевой импорт и Валюты (v2.2.0) ⏳
Планируемые задачи:
- Импорт отчётов брокеров с несколькими ISIN в одной строке
- Поддержка валют: USD, EUR (конвертация через ЦБ РФ API)
